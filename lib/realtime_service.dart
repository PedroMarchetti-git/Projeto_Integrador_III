...
class RealtimeService {
  ...
  //Salva o progresso do jogador usando API REST (Substitui o formato antigo)
  ...
  //Busca as informações de um ambiente (Coordenadas, Imagem, Som) via REST
    static Future<Map<String, dynamic>?> obterProgresso(String userId) async {
    try {
      final url = Uri.parse('$_baseUrl/progresso/$userId.json');
      ...
      debugPrint("Erro ao buscar progresso via REST: $e");
      return null;
    }
  }

  //Busca a árvore de diálogos e múltiplas escolhas de um ambiente via REST
